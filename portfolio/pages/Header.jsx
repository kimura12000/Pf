  ...
  return (
    <header className={styles.header}>
      ...
      <ul  className={`${styles.CloseUL} ${openMenu ? styles.OpenUL : undefined }`}>
        <Link href="/webdesign"><li>WebDesign</li></Link>
        <li>GraphicDesign</li>
        <li>Programing</li>
        <li>Analog</li>
